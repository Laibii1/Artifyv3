...
export const ProductCompTwo = () => {
  const artworks = [
    ...
    { id: 4, src: "/HistoryComp4Img4.jpeg", alt: "Bird Painting" },
    { id: 5, src: "/HistoryComp4Img5.jpeg", alt: "Bird Painting" },
    { id: 6, src: "/HistoryComp4Img6.jpeg", alt: "Bird Painting" },
    
  ];

  return (
    <div className=" text-left mt-20">
     <div className="relative  flex items-start ml-35 my-4 mt-25">
    <span className="text-black-600 font-bold font-outfit text-[20px] lg:text-3xl md:text-3xl sm:text-2xl">
    Recommended Items
    </span>
    </div>

      <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 justify-center gap-4 md:px-30 ml-4 mr-4">
        {artworks.map((art) => (
